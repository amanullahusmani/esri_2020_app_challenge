...
1. The dashboard shows hospital data and clinic data. Firstly, the user needs to decide which kind of service he/she would like to choose. Click the layers icon <img src="https://raw.githubusercontent.com/xuyangHan/esri_2020_app_challenge/master/images/layers-icon.png" alt="drawing" width="200"/> to choose layer and data layers will show at dropdown. Check the desired service later and uncheck the wrong one. 
